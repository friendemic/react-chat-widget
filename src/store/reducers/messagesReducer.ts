...
const messagesReducer = {
  ...
  [ADD_NEW_RESPONSE_MESSAGE]: (state: MessagesState, { text, id, agentAvatar }) =>
    ({ ...state, messages: [...state.messages, createNewMessage(text, MESSAGE_SENDER.RESPONSE, id, agentAvatar)], badgeCount: state.badgeCount + 1 }),
